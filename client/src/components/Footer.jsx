  ...
  return (
    <footer className='text-white mp-20'>
      ...
      <div className='bg-[#FFE5B4] '>
          ...
          <div className='w-full flex flex-wrap gap-10 justify-between -mb-10 -px-4'>
            {footerLinks.map(({ id, title, links }) => (
              <div className='w-auto px-4 ' key={id + title}>
                <h2 className='font-bold text-[#ecb365] tracking-widest text-sm mb-3'>
                  {title}
                </h2>
                ...
                <div className='mb-10 flex flex-col gap-3 '>
                  {links.map((link, index) => (
                    <Link
                      key={link + index}
                      to='/'
                      className='text-gray-500 text-sm hover:text-[#5c3322] '
                    >
                      {link}
                    </Link>
                  ))}
          ...
          <div className='container mx-auto px-5 pt-6 pb-8 flex flex-wrap items-center justify-between '>
            <div className='w-full md:w-2/4 lg:w-1/3 h-16 flex items-center justify-center md:justify-start '>
              ...
              <CustomButton
                title='Subscribe'
                containerStyles={
                  "block bg-[#5C3322] text-white px-5 py-2.5 text-md rounded hover:bg-[#D97706] focus:potline-none flex-col items-center mt-2"
                }
              />
            </div>
        ...
        <div className='bg-[#5C3322]'>
          <div className='container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row'>
            <p className='text-gray-300 text-sm text-center sm:text-left'>
              &copy; 2time Job Finder —
              <a
                href='#.'
                className='text-[#FFE5B4] ml-1'
                target='_blank'
