...
const Navbar = () => {
  ...
  return (
    <>
      <div className='relative bg-[#FFE5B4] z-50'>
        <nav className='container mx-auto flex items-center justify-between p-5'>
          <div>
            <Link to='/' className='text-[#041C32] font-bold text-xl'>
              2<span className='text-[#ECB365]'>Time</span>
            </Link>
          </div>

          <ul className='hidden lg:flex gap-10 text-base-[#041C32]'>
            <li>
